...
def main():
    ...
    np.savetxt(output_file,np.c_[lon_tide,lat_tide,tide_min,tide_max,mllw,mhhw],fmt='%.4f,%.4f,%.4f,%.4f,%.4f,%.4f',delimiter=',',comments='',header='lon,lat,tide_min,tide_max,MLLW,MHHW')
